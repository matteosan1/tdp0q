...
//{
//    auto latin_input = QByteArray::fromStdString(message_part);
//    auto string = QString::fromLatin1(latin_input, latin_input.size());
//    qDebug() << string;
//    return string;
//}
...
//{
//    auto latin_output = str.toLatin1();
...
{
    return QByteArray::fromStdString(message_part);
    //auto string = QString::fromLatin1(latin_input, latin_input.size());
    //qDebug() << string;
    //return string;
}
...
//    byteArray.resize(msg.ByteSize());
//    msg.SerializeToArray(byteArray.data(), byteArray.size());
