...
class Barbero {
 public:
  ...
  void setEstrazione(int i) { m_estrazione = i; }
  ...
  QList<Partito> getPartiti() { return m_partiti; }
  void clearPartiti() { m_partiti.clear(); }
  void clearPartito(int i) { m_partiti.removeAt(i); }
