...
void InitDefaultsPersonImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_address_2eproto::InitDefaultsPerson_PhoneNumber();
  {
...
void InitDefaultsAddressBookImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_address_2eproto::InitDefaultsPerson();
  {
...
const ::google::protobuf::EnumDescriptor* Person_PhoneType_descriptor() {
  ...
  return protobuf_address_2eproto::file_level_enum_descriptors[0];
}
